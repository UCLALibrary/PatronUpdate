--------------------------------------------------------
--  File created - Wednesday-February-27-2008   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package LWS_PATRON
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "LWS_PATRON" AS
/*  The LWS_PATRON package collects together stored procedures and functions
    that are of use to manage patrons in the Voyager Integrated Library System.
    Documentation for functions and procedures are contained in the package 
    body.
    
    Last revised: 2008-02-27 chunt
*/

  /*  voyager_fields_type is used for the associative array of Voyager fields
      to values.
  */
  type voyager_fields_type IS TABLE OF VARCHAR2(50) INDEX BY VARCHAR2(50);
  /*  voyager_fields_order_type is used for the associative array of Voyager 
      fields to field order in the SIF record.
  */
  type voyager_fields_order_type IS TABLE OF VARCHAR2(50) INDEX BY PLS_INTEGER;
  /*  DICT_30_6 is used for the associative array with string keys of length 6 
      and string values of 30. It's used by the NAME functions so first, middle,
      and last can be referred to as such.
  */
  TYPE DICT_30_6 IS TABLE OF VARCHAR2(30) INDEX BY VARCHAR2(6);
  /*  SIF_RECORD stores the fields of the SIF record. SIF format fields that are 
      not used are commented out.
  */
  TYPE SIF_RECORD is RECORD 
  (
    -- SIF Field: patron id
    --  Left blank.
    -- SIF Field: patron barcode id 1
    -- Left blank.
    -- The barcode fields apply to barcode 1. Barcode 3 is not used. Barcode 2
    -- is only used for "changing" a patron's group.
    -- SIF Field: patron barcode 1
    patron_barcode ucladb.PATRON_BARCODE.PATRON_BARCODE%type,
    -- SIF Field: patron group 1
    patron_group ucladb.patron_group.PATRON_GROUP_CODE%type,
    -- SIF Field: barcode status 1
    barcode_status ucladb.PATRON_BARCODE.BARCODE_STATUS%type,
    -- SIF Field: barcode modified date 1
    -- Left blank.
    -- SIF Field: patron barcode id 2
    -- Left blank.
    -- SIF Field: patron barcode 2
    patron_barcode2 ucladb.PATRON_BARCODE.PATRON_BARCODE%type,
    -- SIF Field: patron group 2
    patron_group2 ucladb.patron_group.PATRON_GROUP_CODE%type,
    -- SIF Field: barcode status 2
    barcode_status2 ucladb.PATRON_BARCODE.BARCODE_STATUS%type,
    -- SIF Field: barcode modified date 2
    -- Left blank.
    -- SIF Field: patron barcode id 3
    -- Left blank.
    -- SIF Field: patron barcode 3
    -- Left blank.
    -- SIF Field: patron group 3
    -- Left blank.
    -- SIF Field: barcode status 3
    -- Left blank.
    -- SIF Field: barcode modified date 3
    -- Left blank.
    -- SIF Field: registration date
    registration_date ucladb.patron.REGISTRATION_DATE%type,
    -- SIF Field: patron expiration date
    expire_date ucladb.patron.EXPIRE_DATE%type,
    -- SIF Field: patron purge date
    purge_date ucladb.patron.PURGE_DATE%type,
    -- SIF Field: voyager date
    -- Left blank.
    -- SIF Field: voyager updated
    -- Left blank.
    -- SIF Field: circulation happening location code
    -- Left blank.
    -- SIF Field: institution ID 
    institution_id ucladb.PATRON.INSTITUTION_ID%type,
    -- SIF Field: ssn
    -- Left blank.
    -- SIF Field: statistical category 1
    statistical_category_1 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 2
    statistical_category_2 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 3
    statistical_category_3 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 4
    statistical_category_4 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 5
    statistical_category_5 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 6
    statistical_category_6 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 7
    statistical_category_7 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 8
    statistical_category_8 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 9
    statistical_category_9 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: statistical category 10
    statistical_category_10 ucladb.PATRON_STAT_CODE.PATRON_STAT_CODE%type,
    -- SIF Field: name type
    name_type ucladb.patron.NAME_TYPE%type,
    -- SIF Field: surname
    last_name ucladb.patron.LAST_NAME%type,
    -- SIF Field: first name
    first_name ucladb.patron.FIRST_NAME%type,
    -- SIF Field: middle name
    middle_name ucladb.patron.MIDDLE_NAME%type,
    -- SIF Field: title
    -- Left blank. We don't currently use title for patron records.
    -- SIF Field: historical charges
    -- Left blank.
    -- SIF Field: claims returned
    -- Left blank.
    -- SIF Field: count selfshelved count
    -- Left blank.
    -- SIF Field: lost items count
    -- Left blank.
    -- SIF Field: late media returns
    -- Left blank.
    -- SIF Field: historical bookings
    -- Left blank.
    -- SIF Field: canceled bookings
    -- Left blank.
    -- SIF Field: unclaimed bookings
    -- Left blank.
    -- SIF Field: historical callslips
    -- Left blank.
    -- SIF Field: historical distributions
    -- Left blank.
    -- SIF Field: historical short loans
    -- Left blank.
    -- SIF Field: unclaimed short loans
    -- Left blank.
    -- SIF Field: address count
    -- Left blank. This is calculated by the function based in the passed
    -- parameter.
    -- Here we vary from generic Patron SIF record format. We at most three 
    -- addresses specified by type. The generic fields are:
    -- SIF Field: address id
    -- SIF Field: address type
    -- SIF Field: address status code
    -- SIF Field: address begin date
    -- SIF Field: address end date
    -- SIF Field: address line 1
    -- SIF Field: address line 2
    -- SIF Field: address line 3
    -- SIF Field: address line 4
    -- SIF Field: address line 5
    -- SIF Field: city
    -- SIF Field: state (province) code
    -- SIF Field: zipcode/postal code
    -- SIF Field: country
    -- SIF Field: phone (primary)
    -- SIF Field: phone (mobile)
    -- SIF Field: phone (fax)
    -- SIF Field: phone (other)
    -- SIF Field: date added/updated
    perm_address_line1 ucladb.patron_address.address_line1%type,
    perm_address_line2 ucladb.patron_address.address_line2%type,
    perm_address_line3 ucladb.patron_address.address_line3%type,
    perm_address_line4 ucladb.patron_address.address_line4%type,
    perm_address_line5 ucladb.patron_address.address_line5%type,
    perm_city ucladb.patron_address.city%type,
    perm_state_province ucladb.patron_address.state_province%type,
    perm_zip_postal ucladb.patron_address.zip_postal%type,
    perm_country ucladb.patron_address.country%type,
    perm_effect_date ucladb.patron_address.effect_date%type,
    perm_expire_date ucladb.patron_address.expire_date%type,
    perm_phone_primary ucladb.patron_phone.phone_number%type,
    perm_phone_mobile ucladb.patron_phone.phone_number%type,
    perm_phone_fax ucladb.patron_phone.phone_number%type,
    perm_phone_other ucladb.patron_phone.phone_number%type,
    temp_address_line1 ucladb.patron_address.address_line1%type,
    temp_address_line2 ucladb.patron_address.address_line2%type,
    temp_address_line3 ucladb.patron_address.address_line3%type,
    temp_address_line4 ucladb.patron_address.address_line4%type,
    temp_address_line5 ucladb.patron_address.address_line5%type,
    temp_city ucladb.patron_address.city%type,
    temp_state_province ucladb.patron_address.state_province%type,
    temp_zip_postal ucladb.patron_address.zip_postal%type,
    temp_country ucladb.patron_address.country%type,
    temp_effect_date ucladb.patron_address.effect_date%type,
    temp_expire_date ucladb.patron_address.expire_date%type,
    temp_phone_primary ucladb.patron_phone.phone_number%type,
    temp_phone_mobile ucladb.patron_phone.phone_number%type,
    temp_phone_fax ucladb.patron_phone.phone_number%type,
    temp_phone_other ucladb.patron_phone.phone_number%type,
    email ucladb.patron_address.address_line1%type,
    email_effect_date ucladb.patron_address.effect_date%type,
    email_expire_date ucladb.patron_address.expire_date%type,
    -- address_order is passed by callers to reorder the address records.
    -- Because of a bug in Voyager under certain circumstances duplicate e-mail
    -- address records will be created. To avoid this the address records must 
    -- be ordered in this way: temporary before e-mail when there is no existing
    -- e-amil address, e-mail before temporary when there is no temporary 
    address_order number 
  );
  FUNCTION GET_VOYAGER_FIELD_ORDER(p_address_order number default 0) return voyager_fields_order_type;
  ...
  FUNCTION GET_PATRON_SIF(p_sifr sif_record) RETURN VARCHAR2;
  ...
  FUNCTION PARSE_NAME(p_name vger_report.cmp_registrar.name%TYPE) RETURN DICT_30_6;
  FUNCTION FIRST_NAME(p_name vger_report.cmp_registrar.name%TYPE) RETURN ucladb.patron.FIRST_NAME%TYPE;
  FUNCTION MIDDLE_NAME(p_name vger_report.cmp_registrar.name%TYPE) RETURN ucladb.patron.MIDDLE_NAME%TYPE;
  FUNCTION LAST_NAME(p_name vger_report.cmp_registrar.name%TYPE) RETURN ucladb.patron.LAST_NAME%TYPE;
  ...
  RETURN VARCHAR2;
  PROCEDURE INSERT_NEW_SIF;
  PROCEDURE INSERT_NEW_QDB_SIF;
  PROCEDURE INSERT_LOI_CHANGE_SIF;
  PROCEDURE INSERT_ADDRESS_CHANGE_SIF;
  PROCEDURE INSERT_FSEMAIL_CHANGE_SIF;
  PROCEDURE INSERT_EXTEND_EXP_SIF;
  PROCEDURE INSERT_EXTEND_ELIGIBLE_EXP_SIF;
  PROCEDURE INSERT_GENDER_CHANGE_SIF;
  PROCEDURE INSERT_DIVISION_CHANGE_SIF;
  PROCEDURE INSERT_GROUP_CHANGE_SIF;
  PROCEDURE INSERT_GROUP_EXP_CHANGE_SIF;
  PROCEDURE INSERT_EXTEND_EXP_REG_SIF;
END;

/

  GRANT EXECUTE ON "LWS_PATRON" TO "VGER_REPORT";
 
--------------------------------------------------------
--  DDL for Package Body LWS_PATRON
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "LWS_PATRON" AS
...
*/
  ...
  */
  ...
  BEGIN
    ...
    (
      ...
      email.effect_date,
      email.expire_date,
      --to_date('2008.11.15', 'YYYY.MM.DD')
      --This time we're pushing people just to 2007.12.18
      to_date('2008.12.18', 'YYYY.MM.DD')
    ),
    -- Date created
    sysdate, 
  ...
  */
  ...
  BEGIN
    ...
    -- Pick only records that don't already have this expiration date set.
    and to_char(p.expire_date, 'YYYY.MM.DD') <> '2008.12.18'
    -- Pick only records for faculty, staff, and students.
    and pgc.type between 1 and 4
    -- Pick only records who haven't expired.
    and p.expire_date > sysdate
